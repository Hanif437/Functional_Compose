package com.example.functionalcompose2.screens
...
import com.example.functionalcompose2.ui.theme.Purple700
import com.example.functionalcompose2.ui.theme.Teal200
    ...
    Column(modifier = Modifier
        ...
        OutlinedTextField(
            ...
            modifier = Modifier
                .padding(4.dp)
                .fillMaxWidth(),
            placeholder = { Text(text = buttonLabel,
                "yyyy-mm-dd") }
        )
        OutlinedTextField(
            label = { Text(text = buttonLabel,
